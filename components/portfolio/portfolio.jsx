...
const imagesData = {
    'wszystkie': [
        ...
        { id: '101', src: 'https://media.graphassets.com/i9A5NuhKTpacPtoTCFnz', title: 'Hotel Sokół - Łańcut', alt: 'Kort tenisowy Hotel Sokół Łańcut', href: '/realizacje/lancut', offsetX: '-10px', offsetY: '-70px', size: '115%' },
        ...
        { id: '103', src: 'https://media.graphassets.com/TnXmtDuRMquQyW2uzB0w', title: 'Kort prywatny', alt: 'Kort prywatny', href: '/realizacje/prywatny-dolnoslaskie', offsetX: '-10px', offsetY: '-120px', size: '115%' },
        { id: '104', src: 'https://media.graphassets.com/PkjAnUuMQkObWM1KcKcX', title: 'Kort prywatny', alt: 'Kort prywatny', href: '/realizacje/prywatny-dolnoslaskie-przedmosc', offsetX: '-10px', offsetY: '-120px', size: '115%' },
        { id: '105', src: 'https://media.graphassets.com/XQJQls51RHCkcPOUepB3', title: 'Klub Tenisowy Warszawianka - Warszawa', alt: 'Warszawianka', href: '/realizacje/warszawianka', offsetX: '-10px', offsetY: '-70px', size: '115%' },
        { id: '106', src: 'https://media.graphassets.com/8AeawKfwQdyWAR7Pv902', title: 'Klub Sportowy Czarni - Rzeszów', alt: 'Czarni Rzeszów', href: '/realizacje/czarni-rzeszow-ceglane', offsetX: '-10px', offsetY: '-70px', size: '115%' },
        { id: '107', src: 'https://media.graphassets.com/sBnFomB8SS6P9aB4D74A', title: 'Garwolińska Akademia Tenisa - Garwolin', alt: 'Garwolińska Akademia Tenisa', href: '/realizacje/garwolin', offsetX: '-10px', offsetY: '-70px', size: '115%' },
        { id: '108', src: 'https://media.graphassets.com/1yGpqBIEQniUmn7VwVKG', title: 'TC Poland - Mysiadło', alt: 'Klub TC Poland - Mysiadło', href: '/realizacje/tc-poland', offsetX: '-10px', offsetY: '-70px', size: '115%' },
